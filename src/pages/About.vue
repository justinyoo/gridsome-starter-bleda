    ...
    <main>
      ...
      <article class="max-w-xl md:max-w-2xl xl:max-w-3xl mx-auto px-6 sm:px-12 pt-16 border-b border-gray-300 pb-10 mb-16">
        <div class="markdown text-lg leading-normal text-gray-700">
          ...
          <h3>2020</h3>
          <ol>
            <li>16/01/2020, <a href="https://conf.devopskorea.org/202001/" target="_blank">DevOps Korea</a> &ndash; <a href="/talks/20200116-github-actions-101.pdf">"깃헙 액션, 이것만 알면 참 쉽죠!"</a></li>
          </ol>
        </div>
      </article>
